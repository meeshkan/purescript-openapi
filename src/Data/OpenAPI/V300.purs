...
-- |OpenAPIObject
data OpenAPIObject
  = OpenAPIObject { _openapi :: String, _info :: Info, _paths :: ((OAIMap PathItem)), _externalDocs :: (Maybe ExternalDocumentation), _servers :: (Maybe ((Array Server))), _security :: (Maybe ((Array (OAIMap ((Array String)))))), _tags :: (Maybe ((Array Tag))), _components :: (Maybe Components), _x :: (Maybe ((OAIMap JSON))) }
...
data ExternalDocumentation
  = ExternalDocumentation { _url :: String, _description :: (Maybe String), _x :: (Maybe ((OAIMap JSON))) }
...
-- |Server
data Server
  = Server { _url :: String, _description :: (Maybe String), _variables :: (Maybe ((OAIMap ServerVariable))), _x :: (Maybe ((OAIMap JSON))) }
...
-- |Tag
data Tag
  = Tag { _name :: String, _description :: (Maybe String), _externalDocs :: (Maybe ExternalDocumentation), _x :: (Maybe ((OAIMap JSON))) }
...
-- |Info
data Info
  = Info { _title :: String, _version :: String, _description :: (Maybe String), _termsOfService :: (Maybe String), _contact :: (Maybe Contact), _license :: (Maybe License), _x :: (Maybe ((OAIMap JSON))) }
...
-- |Link
data Link
  = Link { _operationId :: (Maybe String), _operationRef :: (Maybe String), _parameters :: (Maybe ((OAIMap JSON))), _requestBody :: (Maybe JSON), _description :: (Maybe String), _server :: (Maybe Server), _x :: (Maybe ((OAIMap JSON))) }
...
-- |Contact
data Contact
  = Contact { _name :: (Maybe String), _url :: (Maybe String), _email :: (Maybe String), _x :: (Maybe ((OAIMap JSON))) }
...
-- |Response
data Response
  = Response { _description :: String, _headers :: (Maybe ((OAIMap ((ReferenceOr Header))))), _content :: (Maybe ((OAIMap MediaType))), _links :: (Maybe ((OAIMap ((ReferenceOr Link))))), _x :: (Maybe ((OAIMap JSON))) }
...
-- |RequestBody
data RequestBody
  = RequestBody { _content :: ((OAIMap MediaType)), _description :: (Maybe String), _required :: (Maybe Boolean), _x :: (Maybe ((OAIMap JSON))) }
...
-- |Header
data Header
  = Header { _description :: (Maybe String), _required :: (Maybe Boolean), _deprecated :: (Maybe Boolean), _allowEmptyValue :: (Maybe Boolean), _style :: (Maybe String), _explode :: (Maybe Boolean), _allowReserved :: (Maybe Boolean), _schema :: (Maybe (ReferenceOr Schema)), _content :: (Maybe ((OAIMap MediaType))), _example :: (Maybe JSON), _examples :: (Maybe ((OAIMap ((ReferenceOr Example))))), _x :: (Maybe ((OAIMap JSON))) }
...
-- |ServerVariable
data ServerVariable
  = ServerVariable { _default :: String, _enum :: (Maybe ((Array String))), _description :: (Maybe String), _x :: (Maybe ((OAIMap JSON))) }
...
-- |License
data License
  = License { _name :: String, _url :: (Maybe String), _x :: (Maybe ((OAIMap JSON))) }
...
-- |Example
data Example
  = Example { _summary :: (Maybe String), _description :: (Maybe String), _value :: (Maybe JSON), _externalValue :: (Maybe String), _x :: (Maybe ((OAIMap JSON))) }
...
-- |Reference
data Reference
  = Reference { _ref :: String, _x :: (Maybe ((OAIMap JSON))) }
...
data OpenIdConnectSecurityScheme
  = OpenIdConnectSecurityScheme { _type :: String, _openIdConnectUrl :: String, _description :: (Maybe String), _x :: (Maybe ((OAIMap JSON))) }
...
-- |Discriminator
data Discriminator
  = Discriminator { _propertyName :: String, _mapping :: (Maybe ((OAIMap String))), _x :: (Maybe ((OAIMap JSON))) }
...
data OAuth2SecurityScheme
  = OAuth2SecurityScheme { _flows :: OAuthFlows, _type :: String, _description :: (Maybe String), _x :: (Maybe ((OAIMap JSON))) }
...
-- |MediaType
data MediaType
  = MediaType { _schema :: (Maybe (ReferenceOr Schema)), _example :: (Maybe JSON), _examples :: (Maybe ((OAIMap ((ReferenceOr Example))))), _encoding :: (Maybe ((OAIMap Encoding))), _x :: (Maybe ((OAIMap JSON))) }
...
data APIKeySecurityScheme
  = APIKeySecurityScheme { _name :: String, _type :: String, _in :: String, _description :: (Maybe String), _x :: (Maybe ((OAIMap JSON))) }
...
-- |XML
data XML
  = XML { _name :: (Maybe String), _namespace :: (Maybe String), _prefix :: (Maybe String), _attribute :: (Maybe Boolean), _wrapped :: (Maybe Boolean), _x :: (Maybe ((OAIMap JSON))) }
...
data HTTPSecurityScheme
  = HTTPSecurityScheme { _type :: String, _scheme :: String, _bearerFormat :: (Maybe String), _description :: (Maybe String), _x :: (Maybe ((OAIMap JSON))) }
...
-- |Encoding
data Encoding
  = Encoding { _contentType :: (Maybe String), _headers :: (Maybe ((OAIMap Header))), _style :: (Maybe String), _explode :: (Maybe Boolean), _allowReserved :: (Maybe Boolean), _x :: (Maybe ((OAIMap JSON))) }
...
-- |OAuthFlows
data OAuthFlows
  = OAuthFlows { _implicit :: (Maybe ImplicitOAuthFlow), _password :: (Maybe PasswordOAuthFlow), _clientCredentials :: (Maybe ClientCredentialsFlow), _authorizationCode :: (Maybe AuthorizationCodeOAuthFlow), _x :: (Maybe ((OAIMap JSON))) }
...
-- |ImplicitOAuthFlow
data ImplicitOAuthFlow
  = ImplicitOAuthFlow { _authorizationUrl :: String, _scopes :: ((OAIMap String)), _refreshUrl :: (Maybe String), _x :: (Maybe ((OAIMap JSON))) }
...
-- |AuthorizationCodeOAuthFlow
data AuthorizationCodeOAuthFlow
  = AuthorizationCodeOAuthFlow { _tokenUrl :: String, _authorizationUrl :: String, _refreshUrl :: (Maybe String), _scopes :: (Maybe ((OAIMap String))), _x :: (Maybe ((OAIMap JSON))) }
...
data ClientCredentialsFlow
  = ClientCredentialsFlow { _tokenUrl :: String, _refreshUrl :: (Maybe String), _scopes :: (Maybe ((OAIMap String))), _x :: (Maybe ((OAIMap JSON))) }
...
-- |PasswordOAuthFlow
data PasswordOAuthFlow
  = PasswordOAuthFlow { _tokenUrl :: String, _refreshUrl :: (Maybe String), _scopes :: (Maybe ((OAIMap String))), _x :: (Maybe ((OAIMap JSON))) }
